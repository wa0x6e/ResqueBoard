 ...
 */
?>
        <footer class="container"><p><img src="/img/resqueboard.png" alt="ResqueBoard" width=16 height=16 /> Powered by <a href="https://github.com/kamisama/ResqueBoard" title="ResqueBoard website">RescueBoard</a></p></footer>
